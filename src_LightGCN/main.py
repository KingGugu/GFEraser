...
from models import GFEraser, Original
...
def main():
    ...
    parser.add_argument('--original_model', type=str, default='LightGCN')
    ...
    parser.add_argument("--cl_weight", type=float, default=0.4, help="weight of cl task")
    parser.add_argument("--pos_bpr_weight", type=float, default=0.02, help="weight of cl task")
